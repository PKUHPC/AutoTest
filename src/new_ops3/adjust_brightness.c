...
#define adjust_brightness_kernel(typename)     \
...
Status aitisa_adjust_brightness(const Tensor input, double brightness_factor, Tensor *output)
{
    ...
    if (ndim == 3) // [C, H, W]
    {
        ...
        *output = new_tensor;
        ...
        AITISA_DISPATCH_ALL_TYPES_RETURN(dtype, adjust_brightness_kernel);
    }
