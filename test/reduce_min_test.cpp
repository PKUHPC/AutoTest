...
void reduce_min_assign_int32(Tensor t) {
...
void reduce_min_assign_float(Tensor t) {
  int64_t size = aitisa_tensor_size(t);
...
TEST(Reduce_min, Float) {
  ...
  reduce_min_assign_float(input);

  int64_t dims[3] = {2, 1, 3};
  int64_t dims_length = 3;
  aitisa_reduce_min(input, dims, dims_length, 0, &output);

  double test_data[] = {1.000000, 13.000000};
...
TEST(Reduce_min, Int32) {
  ...
  double test_data[] = {1.000000,  2.000000,  3.000000,
