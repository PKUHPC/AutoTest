...
TEST(Reduce_prod, Float) {
  ...
  float test_data[] = {479001600.000000, 1295295050649600.000000};
...
TEST(Reduce_prod, Int32) {
  ...
  int32_t test_data[] = {280, 880, 1944, 86944, 109480, 136080};
