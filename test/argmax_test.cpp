...
void arg_max_assign_int32(Tensor t) {
...
void arg_max_assign_float(Tensor t) {
  int64_t size = aitisa_tensor_size(t);
...
TEST(Arg_max, Float) {
  ...
  arg_max_assign_float(input);

  int64_t dim = 3;
  aitisa_argmax(input, dim, 0, &output);
