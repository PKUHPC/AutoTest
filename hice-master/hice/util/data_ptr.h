// This file is based on c10\util\UniqueVoidPtr.h from PyTorch. 
...
class DataPtr {
 ...
 public:
  ...
  bool compare_exchange_deleter(DeleterFnPtr expected_deleter, DeleterFnPtr new_deleter) {
