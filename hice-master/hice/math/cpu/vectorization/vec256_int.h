// This file is based on aten\src\Aten\cpu\vec256\vec256_int.h from PyTorch.
...
struct Vec256<int64_t> : public Vec256i {
  ...
  static Vec256<int64_t> blend(Vec256<int64_t> a, Vec256<int64_t> b) {
    __hice_align32__ int64_t tmp_values[size()];
    a.store(tmp_values);
    if (mask & 0x01)
  ...
  static Vec256<int64_t> set(Vec256<int64_t> a, 
                             Vec256<int64_t> b, 
                             int64_t count = size()) {
    switch (count) {
      case 0:
...
struct Vec256<int32_t> : public Vec256i {
  ...
  static Vec256<int32_t> loadu(const void* ptr, int32_t count) {
    __hice_align32__ int32_t tmp_values[size()];
...
struct Vec256<int16_t> : public Vec256i {
  ...
  static Vec256<int16_t> blend(Vec256<int16_t> a, Vec256<int16_t> b) {
    __hice_align32__ int16_t tmp_values[size()];
    a.store(tmp_values);
    if (mask & 0x01)
