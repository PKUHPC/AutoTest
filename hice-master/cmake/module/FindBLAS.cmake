...
SET(BLAS_ROOT_DIR "" CACHE STRING "BLAS root directory")
...
if (BLAS_VENDOR STREQUAL "PhiPACK" OR BLAS_VENDOR STREQUAL "All")
  if(NOT BLAS_LIBRARIES)
    check_fortran_libraries(
      BLAS_LIBRARIES
      BLAS
...
if (BLAS_VENDOR STREQUAL "CXML" OR BLAS_VENDOR STREQUAL "All")
  if(NOT BLAS_LIBRARIES)
    check_fortran_libraries(
      BLAS_LIBRARIES
      BLAS
...
if (BLAS_VENDOR STREQUAL "DXML" OR BLAS_VENDOR STREQUAL "All")
  if(NOT BLAS_LIBRARIES)
    check_fortran_libraries(
      BLAS_LIBRARIES
      BLAS
...
if (BLAS_VENDOR STREQUAL "SunPerf" OR BLAS_VENDOR STREQUAL "All")
  if(NOT BLAS_LIBRARIES)
    check_fortran_libraries(
      BLAS_LIBRARIES
      BLAS
...
if (BLAS_VENDOR STREQUAL "SCSL" OR BLAS_VENDOR STREQUAL "All")
  if(NOT BLAS_LIBRARIES)
    check_fortran_libraries(
      BLAS_LIBRARIES
      BLAS
...
if (BLAS_VENDOR STREQUAL "SGIMATH" OR BLAS_VENDOR STREQUAL "All")
  if(NOT BLAS_LIBRARIES)
    check_fortran_libraries(
      BLAS_LIBRARIES
      BLAS
...
if (BLAS_VENDOR STREQUAL "IBMESSL" OR BLAS_VENDOR STREQUAL "All")
  if(NOT BLAS_LIBRARIES)
    check_fortran_libraries(
      BLAS_LIBRARIES
      BLAS
...
if (BLAS_VENDOR MATCHES "ACML" OR BLAS_VENDOR STREQUAL "All")
  if( ((BLAS_VENDOR STREQUAL "ACML") AND (NOT BLAS_ACML_LIB_DIRS)) OR
    ((BLAS_VENDOR STREQUAL "ACML_MP") AND (NOT BLAS_ACML_MP_LIB_DIRS)) OR
    ((BLAS_VENDOR STREQUAL "ACML_GPU") AND (NOT BLAS_ACML_GPU_LIB_DIRS))
    )
  ...
  if( _ACML_ROOT )
    ...
    if( BLAS_VENDOR STREQUAL "ACML_MP" )
...
elseif(BLAS_${BLAS_VENDOR}_LIB_DIRS)
  set(_${BLAS_VENDOR}_LIB_DIRS ${BLAS_${BLAS_VENDOR}_LIB_DIRS})
endif()
...
if( BLAS_VENDOR STREQUAL "ACML_MP" )
  ...
  endforeach()
elseif( BLAS_VENDOR STREQUAL "ACML_GPU" )
...
if(NOT BLAS_FIND_QUIETLY)
 if(BLAS_FOUND)
   ...
   if(BLAS_FIND_REQUIRED)
     ...
     message(STATUS
     "A library with BLAS API not found. Not using BLAS. Please specify library location."
     )
   endif()
 endif()
endif()
