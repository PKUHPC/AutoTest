...
IF (NOT MKL_FOUND)
  ...
  SET(MKL_ROOT_DIR "/opt/intel/mkl" CACHE STRING
  ...
  IF (EXISTS ${INTEL_COMPILER_DIR})
    ...
    IF (NOT EXISTS ${MKL_ROOT_DIR})
      SET(MKL_ROOT_DIR "${INTEL_COMPILER_DIR}/mkl")
    ENDIF()
  ENDIF()
  IF (EXISTS ${MKL_ROOT_DIR})
    ...
    SET(CMAKE_LIBRARY_PATH ${CMAKE_LIBRARY_PATH}
      "${MKL_ROOT_DIR}/lib/${mklvers}")
    IF (MSVC)
      SET(CMAKE_LIBRARY_PATH ${CMAKE_LIBRARY_PATH}
        "${MKL_ROOT_DIR}/lib/${iccvers}")
    ENDIF()
  ENDIF()
  ...
  if(NOT MKL_FIND_QUIETLY)
   if(MKL_FOUND)
     ...
     if(MKL_FIND_REQUIRED)
       message(FATAL_ERROR
       "A required library with MKL API not found. Please specify library location."
       )
     else()
       message(STATUS
       "A library with MKL API not found. Please specify library location."
       )
     endif()
   endif()
  endif()
