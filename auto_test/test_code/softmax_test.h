...
namespace aitisa_api {
    ...
    namespace {
        ...
        public:
            Softmax_Input() {};
            Softmax_Input(int64_t ndim, std::vector<int64_t> dims, int dtype,
    ...
    public:
        ...
        // inputs
        Softmax_Input input0; // Natural assigned int32 type input of CPU with InputDims1{3,3,10,6}, FilterDims2{5,3,2,2}, stride{2,2}, padding{0,0}, dilation{1,1}
        Softmax_Input input1; // Random assigned double type input of CUDA with InputDims1{10,3,100,124,20}, FilterDims2{10,3,5,5,5}, stride{5,5,5}, padding{0,1,0}, dilation{1,1,1}
        Softmax_Input *input[2] = {&input0, &input1};
        std::string input0_name = "Random float of CPU with InputDims{256, 256,256}, axis{2}";
        std::string input1_name = "Random float of CPU with InputDims{64, 64, 64, 64}, axis{3} ";
...
//            void * data_ =  aitisa_tensor_data(aitisa_result);
//            auto * data = (float*)data_;
