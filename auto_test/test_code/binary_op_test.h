...
class BinaryOPTest : public ::testing::Test {
 public:
  ...
  std::string input0_name =
      "Natural int32 CPU with Dims{10,6} and Dims{10,6} for add";
  std::string input1_name =
      "Random Double CPU with Dims{2013,2018} and Dims{2013,2018} dor sub";
  std::string input2_name =
      "Natural uint64 CPU with Dims{10,3,2} and Dims{10,3,2} for mul";
  std::string input3_name =
      "Natural Float CPU with Dims{5} and Dims{5} for div";
  std::string* input_name[4] = {&input0_name, &input1_name, &input2_name,
                                &input3_name};
  int ninput = 4;
};
